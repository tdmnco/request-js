...
// Tests:
test('Static GET (200) /users/1 (status)', () => {
...
test('Static GET (200) /users/1 (payload)', () => {
...
test('Static GET (404) /users/1 (status)', () => {
...
test('Static GET (404) /users/1 (payload)', () => {
